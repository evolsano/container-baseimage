...
[hub]: https://hub.docker.com/r/evolsano/light-baseimage/

Latest release: 0.1.10 [Changelog](CHANGELOG.md)
 | [Docker Hub](https://hub.docker.com/r/evolsano/light-baseimage/) 
...
In the Dockerfile we are going to:
  ...
  - Define ports exposed and volumes if needed.
	    ...
	    FROM osixia/light-baseimage:alpine-0.1.10
...
*Run tool* takes several options, to list them:
    ...
    docker run osixia/light-baseimage:alpine-0.1.10 --help
...
Example:
    ...
    docker run -it osixia/light-baseimage:alpine-0.1.10
...
Can also be set by command line converted in python or json:
    ...
    docker run -it --env FRUITS="#PYTHON2BASH:['orange','apple']" osixia/light-baseimage:alpine-0.1.10 printenv
    docker run -it --env FRUITS="#JSON2BASH:[\"orange\",\"apple\"]" osixia/light-baseimage:alpine-0.1.10 printenv
